...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        ArrayList<Integer> listDivide2 = new ArrayList<Integer>();
        ArrayList<Integer> listDivide3 = new ArrayList<Integer>();
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i) % 2 == 0){
                listDivide2.add(list.get(i));
            } if (list.get(i) % 3 == 0){
                listDivide3.add(list.get(i));
